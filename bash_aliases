...
alias datapy="source /home/mikhailhyde/.venvs/data/bin/activate"

# Enable Printer Emulation Python Virtualenv - Python 3.5
alias printerpy="source /home/mikhailhyde/.venvs/printer/bin/activate"

# Enable TARS Emulation Python Virtualenv - Python 3.6
alias tarspy="source /home/mikhailhyde/.venvs/tars/bin/activate"
